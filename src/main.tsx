...
ReactDOM.createRoot(document.getElementById("root")!).render(
  <React.StrictMode>
    ...
    <Subheader
      ...
      path_img={["../imgs/html.png", "../imgs/js.png", "../imgs/ts.jpg","../imgs/python.png"]}
    />
